...
import com.dtu.deltecdtu.databinding.FragmentTwoZeroTwoFourBinding
...
class TwoZeroTwoFourFragment : Fragment(), HolidayItemClickListener {
    private var _binding: FragmentTwoZeroTwoFourBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTwoZeroTwoFourBinding.inflate(inflater, container, false)
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvRecyclerviewListOfHolidays2024.adapter = holidayAdapter
    }
    ...
    private fun monitorHolidayData() {
        viewModel.holidaysLiveData2024.observe(viewLifecycleOwner, Observer { Resource ->
            when (Resource) {

...
import com.dtu.deltecdtu.databinding.FragmentEventsBinding
...
import com.dtu.deltecdtu.viewmodel.EventsViewModel
...
class EventsFragment : Fragment(), NoticeClickListener {
    ...
    override fun onCreateView(
        ...
        viewModel.latestEventsLiveData.observe(viewLifecycleOwner, Observer { response ->
            when (response) {
                is Response.Success -> {
                    hideProgressBar()
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvEventsFragmentRecyclerView.adapter = dtuNoticeAdapter
    }

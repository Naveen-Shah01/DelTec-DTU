...
class FirstYearFragment : Fragment(), NoticeClickListener {

    private lateinit var viewModel: FirstYearViewModel
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFirstYearBinding.inflate(inflater, container, false)

        viewModel = ViewModelProvider(this)[FirstYearViewModel::class.java]

        setupRecyclerView()

        viewModel.fetchLatestNews()
        viewModel.firstYearLiveData.observe(viewLifecycleOwner, Observer { response ->
            when (response) {
                is Response.Success -> {
                    hideProgressBar()
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvFirstYearFragmentRecyclerView.adapter = dtuNoticeAdapter
    }

...
import com.dtu.deltecdtu.databinding.FragmentJobsBinding
...
import com.dtu.deltecdtu.viewmodel.JobsViewModel
...
class JobsFragment : Fragment(), NoticeClickListener {
    ...
    override fun onCreateView(
        ...
        viewModel.jobsLiveData.observe(viewLifecycleOwner, Observer { response ->
            when (response) {
                is Response.Success -> {
                    hideProgressBar()
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvJobsFragmentRecyclerView.adapter = dtuNoticeAdapter
    }

package com.dtu.deltecdtu.ui.fragments.notices
...
import com.dtu.deltecdtu.databinding.FragmentTendersBinding
...
import com.dtu.deltecdtu.viewmodel.TendersViewModel
...
class TendersFragment : Fragment(), NoticeClickListener {
    ...
    private var _binding: FragmentTendersBinding? = null
    private val binding get() = _binding!!

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View {
        _binding = FragmentTendersBinding.inflate(inflater, container, false)

        viewModel = ViewModelProvider(this)[TendersViewModel::class.java]

        setupRecyclerView()

        viewModel.fetchLatestNews()
        viewModel.tendersLiveData.observe(viewLifecycleOwner, Observer { response ->
            when (response) {
                is Response.Success -> {
                    hideProgressBar()
    ...
    private fun setupRecyclerView() {
        ...
        binding.rvTendersFragmentRecyclerView.adapter = dtuNoticeAdapter
    }
